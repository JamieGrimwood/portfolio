        ...
        <div className="h-screen">
            ...
            >
                ...
                <div className="flex flex-col absolute top-0 left-0 z-10">
                    <div className="flex flex-col justify-center h-screen ml-16">
                        <h1 className="text-8xl text-white font-bold ">Hi, I&apos;m Jamie</h1>
                        <h2 className="text-2xl text-white">I&apos;m a fullstack web developer and System Administrator</h2>
