      ...
      <Card className="fadein-main mt-4">
        <div className="sm:flex sm:justify-between">
          ...
          <img
            ...
            className="sm:w-2/5 border rounded-lg sm:ml-4 sm:mt-0 mt-4"
          />
        </div>
        <div className="sm:flex sm:justify-between">
          <img
            ...
            className="w-2/5 border rounded-lg hidden sm:block"
          />
          ...
          <img
            src="/projects/explorers-panel/explorers-panel-login.png"
            id="explorers-panel-image"
            className="border rounded-lg mt-4 sm:hidden block"
          />
        </div>
